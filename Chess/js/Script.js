...
var board = null;
var $board = $('#myBoard');function spillMotMinMax(farge, id) {
   /*
 * A simple chess AI, by someone who doesn't know how to play chess.
 * Uses the chessboard.js and chess.js libraries.
 *
  ...
  switch(farge) {
    case 'white' : {
      switch(id) {
        ...
        case 'fransk' : {
          board.position('rnbqkbnr/pppp1ppp/4p3/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2')
          game.load('rnbqkbnr/pppp1ppp/4p3/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2')
          break
        }
        case 'spansk' : {
...
var game = new Chess();
var globalSum = -0; // always from black's perspective. Negative for white's perspective.
var whiteSquareGrey = '#a9a9a9';function spillMotMinMax(farge, id) {
   /*
 * A simple chess AI, by someone who doesn't know how to play chess.
 * Uses the chessboard.js and chess.js libraries.
 *
